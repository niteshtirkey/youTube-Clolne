...
import {video,like,dislike,share,save, jack, user_profile} from '../../assets/index'
...
const PlayVideo = () => {
    ...
    const [channelData, setChaneelData] =useState(null);
    ...
    const fetchOtherData=async()=>{
        ...
        await fetch(channelData_url).then(res=>res.json()).then(data=>setChaneelData(data.items[0]));
